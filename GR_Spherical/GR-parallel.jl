...
@parallel function compute_P!(P::Data.Array, Vx::Data.Array, Vy::Data.Array, dt::Data.Number, k::Data.Number, dx::Data.Number, dy::Data.Number)
    @all(P) = @all(P) - dt*k*(D*Vx/dx + D*Vy/dy)
    return
end
...
@views function main()
    ...
    t         = 0.0         # physical time
    # Numerics
    nx        = n           # numerical grid resolution; should be a mulitple of 32-1 for optimal GPU perf
    ny        = nx
    ...
    # return gif(anim, "acoustic2D.gif", fps = 15)
end
