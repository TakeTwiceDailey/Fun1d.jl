...
@views function acoustic3D()
    ...
    t          = 0.0               # physical time
    # Numerics
    nx, ny, nz = 2*127, 127, 127     # numerical grid resolution; should be a mulitple of 32-1 for optimal GPU perf
    ...
    if (me==0) && VISUAL gif(anim, "acoustic3D.gif", fps = 15) end
